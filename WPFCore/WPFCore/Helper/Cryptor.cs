...
namespace WPFCore.Helper
{
    public static class Cryptor
    {
        ...
        /// <param name="initVector">The initialization vector.</param>
        /// <returns></returns>
        private static byte[] Encrypt(byte[] clearData, byte[] key, byte[] initVector)
        {
        ...
        public static string Encrypt(string clearText, string password)
        {
            ...
            // We are going to be using Base64 encoding that is designed exactly for what we
            // are trying to do. 
        ...
        /// <returns></returns>
        private static byte[] Decrypt(byte[] cipherData, byte[] key, byte[] initVector)
        {
            ...
            // of the data after it is decrypted, and then each decrypted block is XORed with the 
            // previous cipher block. This is done to make encryption more secure. 
            // There is also a mode called ECB which does not need an IV, but it is much less secure. 
            alg.Key = key;
            alg.IV = initVector;
        ...
        public static string Decrypt(string cipherText, string password)
        {
            ...
            // A common mistake would be to use an Encoding class for that.
            // It does not work  because not all byte values can be represented by characters. 
            // We are going to be using Base64 encoding that is designed exactly for what 
            // we are trying to do. 
