...
namespace WPFCore.XAML.Behaviors
{
    public class CommandBehaviorCollection
    {
        ...
        ///     As you can see the PowerUp readonly property has a name registered different (BehaviorsInternal) than the property name, this is a tricks os that we can construct the collection as we want
